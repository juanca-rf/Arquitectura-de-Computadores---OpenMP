...
//./pmm-secuencial 40 && ./pmm-secuencial-modificado_A 40 && ./pmm-secuencial-modificado_B 40^C
//#define VECTOR_LOCAL	
//#define VECTOR_GLOBAL 
#define VECTOR_DYNAMIC 
#ifdef VECTOR_GLOBAL
#define MAX 5792 //sqrt 2^25
double m1[MAX][MAX], m2[MAX], m3[MAX];
#endif
...
#ifdef VECTOR_LOCAL
    double v1[N], m2[N], m3[N]; // TamaÃ±o variable local en tiempo de ejecuciÃ³n ...
